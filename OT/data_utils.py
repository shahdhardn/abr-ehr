...
def build_dataset(dataset, num_meta):
    ...
    # TODO add mimic dataset
    if dataset == "cifar10":
        train_dataset = torchvision.datasets.CIFAR10(
            root="../cifar-10", train=True, download=False, transform=transform_train
        )
        test_dataset = torchvision.datasets.CIFAR10(
            "../cifar-10", train=False, transform=transform_test
        )
    ...
    if dataset == "cifar100":
        train_dataset = torchvision.datasets.CIFAR100(
            root="../cifar-100", train=True, download=True, transform=transform_train
        )
        test_dataset = torchvision.datasets.CIFAR100(
            "../cifar-100", train=False, transform=transform_test
        )
